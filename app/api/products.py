...
from app.kafka.producer import get_kafka_producer, update_product_desc_to_local_db
...
@router.get(
    "/",
    summary="Return products, which are not deleted.",
...
@router_admin.get(
    "/all",
    summary="Return all products, include deleted.",
...
async def replace_product(
    ...
    return await update_product_method(
...
async def update_product_method(
    product_id: int, 
    product, 
    db,
    producer,
    ...
    await update_product_desc_to_local_db(
        producer=producer,
