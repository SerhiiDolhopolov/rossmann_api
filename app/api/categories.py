...
from app.schemas import CategorySchema, CategoryAddSchema, CategoryPatchSchema
...
@router.get('/all', summary='Return all categories.', response_model=list[CategorySchema])
...
@router.patch('/update/{category_id}', response_model=CategorySchema)
